...
{
    public class DoubleTriangleWaveFunc : IWaveFunc
    {
        ...
        /// </value>
        public string WaveName => WaveNames.DoubleTriangle;

        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleTriangleWaveFunc"/> class.
        /// </summary>
        /// <param name="initialRate">The initial rate.</param>
        /// <param name="amplitude">The amplitude.</param>
        /// <param name="periodInMilliseconds">The period in milliseconds.</param>
        public DoubleTriangleWaveFunc(decimal initialRate, decimal amplitude, int periodInMilliseconds)
        {
        ...
        {
            return _initialRate + (2 * _amplitude / Convert.ToDecimal(PI)) * Convert.ToDecimal(Asin(Sin(4 * PI * timeInMilliseconds / _periodInMilliseconds)) * Sign(Cos(2 * PI * timeInMilliseconds / _periodInMilliseconds)));
        }       
    }
}
