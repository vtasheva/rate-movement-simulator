...
namespace Internovus.Wpf.Training.RateFeed.Implementations.Waves
{
    public class TriangleWaveFunc : IWaveFunc
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TriangleWaveFunc"/> class.
        /// </summary>
        /// <param name="initialRate">The initial rate.</param>
        /// <param name="amplitude">The amplitude.</param>
        /// <param name="periodInMilliseconds">The period in milliseconds.</param>
        public TriangleWaveFunc(string symbolName, decimal initialRate, decimal amplitude, int periodInMilliseconds)
        {
